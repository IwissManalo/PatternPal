...
export default function SplashScreen3({ navigation }: { navigation: any }) {
        ...
        Animated.timing(fadeAnim, {
            ...
            setTimeout(() => {
                Animated.timing(fadeAnim, {
                    ...
                    navigation.replace('SignupScreen'); // Navigate to SignupScreen
                });
...
const styles = StyleSheet.create({
    container: {
        ...
        alignItems: 'center',
        backgroundColor: '#6BC9FF', // Background color
    },
    logo: {
        width: 300,
        height: 300,
